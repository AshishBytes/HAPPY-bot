  ...
  **34: ** [\`${Radiostations[34-1].split(" ")[0]}\`](${Radiostations[34-1].split(" ")[1]})`, inline: true },
  ...
  const song = {
    title: args2[0],
    url: args2[1],
    thumbnail: "https://cdn.discordapp.com/attachments/788769478472105984/834745553555554304/3a5b4519843dc3d1435c60802c85560d.png",
    duration: 10000,
  };
  ...
  message.channel.send(new MessageEmbed().setColor("AQUA")
